...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { return step("next", value); }, function (err) { return step("throw", err); }); } } return step("next"); }); }; } /** @module Urlencoded */
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 8:
                        ...
                        return _context.abrupt('return', (0, _querystring.parse)(string.toString()));

                    case 12:
                        _context.prev = 12;
                        _context.t0 = _context['catch'](3);

                        if (!(_context.t0.type === 'entity.too.large')) {
                            _context.next = 18;
                            break;
                        }

                        throw new _error.HttpError('Body exceeded ' + limit + ' limit', 413, 40013, _context.t0);

                    case 18:
                        throw new _error.HttpError('Invalid body', 400, 40001, _context.t0);
